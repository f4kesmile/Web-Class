...
export const BlurImage = ({
  ...
  const { blurDataURL, fill, ...cleanProps } = rest as any;
  ...
  if (!hasImage) {
    return (
      <div
        className={cn(
          "h-full w-full bg-neutral-200 dark:bg-neutral-800 flex flex-col items-center justify-center text-neutral-500",
          className
        )}
      >
